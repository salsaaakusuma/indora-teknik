...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"> Edit Barang <span class="text-muted fw-light">/Stock</span></h4>
    ...
    <div class="row">
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-body">
                <form action="{{ route('update.barsto', $data->id) }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="basic-default-name">Kategori Barang</label>
                <div class="col-sm-10">
                    <input type="text" id="kategori_barang" name="kategori_barang" class="form-control form-control @error('kategori_barang') is-invalid @enderror" value="{{ old('kategori_barang', $data->kategori_barang) }}" placeholder="Kategori"/>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" id="nama_barang" name="nama_barang" class="form-control form-control @error('nama_barang') is-invalid @enderror" value="{{old('nama_barang', $data->nama_barang) }}" placeholder="Nama Barang"/>
                    @error('nama_barang')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                      </span>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" id="stok_barang" name="stok_barang" class="form-control form-control @error('stok_barang') is-invalid @enderror" value="{{old('stok_barang', $data->stok_barang) }}" placeholder="Jumlah Stok"/>
                    @error('stok_barang')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                      </span>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" id="harga_beli" name="harga_beli" class="form-control form-control @error('harga_beli') is-invalid @enderror" value="{{old('harga_beli', $data->harga_beli) }}" placeholder="Harga Beli"/>
                    @error('harga_beli')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                      </span>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" id="harga_jual" name="harga_jual" class="form-control form-control @error('harga_jual') is-invalid @enderror" value="{{old('harga_jual', $data->harga_jual) }}" placeholder="Harga Jual"/>
                    @error('harga_jual')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                      </span>
